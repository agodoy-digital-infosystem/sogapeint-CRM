...
var FakeBackendInterceptor = /** @class */ (function () {
    ...
    FakeBackendInterceptor.prototype.intercept = function (request, next) {
        ...
        var users = JSON.parse(localStorage.getItem('users')) || [{ username: 'admin', email: 'admin@sogapeint.corp', password: '123456' }];
        ...
        return rxjs_1.of(null).pipe(operators_1.mergeMap(function () {
            ...
            if (request.url.endsWith('/users/authenticate') && request.method === 'POST') {
                ...
                if (filteredUsers.length) {
                    ...
                    return rxjs_1.throwError({ error: { message: 'Le mot de passe ou l\'adresse e-mail est incorecte' } });
                }
            }
            // get users
