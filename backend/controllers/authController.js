...
exports.resetPasswordFromAdmin = async (req, res) => {
  ...
  exports.updateCompany = async (req, res) => {
    ...
    try {
      // // console.log('Modification de l’entreprise');
      const { companyId } = req.params;
      const { normalized_name, address, city, postalCode, country, phone, email, website, employees, documents, contractsAsCustomer, contractsAsContact, contractsAsExternalContributor, additionalFields } = req.body;
      // // console.log('Company id:', companyId);
      // Mise à jour de l'entreprise
      const updatedCompany = await CompanyModel.findByIdAndUpdate(new mongoose.Types.ObjectId(companyId), {
        normalized_name, address, city, postalCode, country, phone, email, website, employees, documents, contractsAsCustomer, contractsAsContact, contractsAsExternalContributor, additionalFields
      }, { new: true });
